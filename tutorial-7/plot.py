...
matrix_add_data = np.loadtxt("clustering_results_parallel.txt", skiprows=0)
...
plt.plot(threads_list, execution_times, color='y', marker='o', label='Clustering Algorithm')
...
plt.figure(figsize=(8, 6))
plt.plot(threads_list[1:], speedup, color='g', marker='o', label='Clustering Algorithm SpeedUp')
